...
@Component({
	selector: 'app-media-files-tree-control',
	templateUrl: './media-files-tree-control.component.html',
	styleUrls: ['./media-files-tree-control.component.scss'],
	// providers: [FileDatabase]
})
export class MediaFilesTreeControlComponent extends SimpleBaseComponent {
