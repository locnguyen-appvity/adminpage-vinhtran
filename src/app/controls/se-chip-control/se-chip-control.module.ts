...
import { SEChipControlComponent } from './se-chip-control.component';
...
@NgModule({
	...
	declarations: [SEChipControlComponent],
	exports: [SEChipControlComponent]
})
export class SEChipControlModule { 
