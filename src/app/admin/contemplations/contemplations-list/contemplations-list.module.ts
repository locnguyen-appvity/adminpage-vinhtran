...
import { ContemplationsListRoutingModule } from './contemplations-list-routing.module';
...
@NgModule({
  declarations: [
    ContemplationsListComponent
  ],
  imports: [
    SharedModule,
    ContemplationsListRoutingModule,
    MatMenuModule,
    MatTableModule,
    MatPaginatorModule,
  ...
  exports: [ContemplationsListComponent]
})
export class ContemplationListModule { 
