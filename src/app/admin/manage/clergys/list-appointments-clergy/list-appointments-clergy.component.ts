...
@Component({
	selector: 'se-list-appointments-clergy',
	templateUrl: './list-appointments-clergy.component.html',
	styleUrls: ['./list-appointments-clergy.component.scss']
})
export class ListAppointmentsClergyComponent extends SimpleBaseComponent implements OnChanges {
